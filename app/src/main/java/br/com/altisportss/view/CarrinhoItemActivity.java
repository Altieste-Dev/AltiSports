...
import br.com.altisportss.controller.CarrinhoItemController;

public class CarrinhoItemActivity extends AppCompatActivity {

    private CarrinhoItemController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialize();
        controller = new CarrinhoItemController(this);
